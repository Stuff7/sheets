...
const _jsx$templ2 = _jsx$template(`<label data-button class="relative focus-children has-checked:bg-indigo-500! has-checked:hover:bg-indigo-700! has-checked:text-zinc-100! dark:has-checked:bg-emerald-500! dark:has-checked:text-zinc-900! dark:has-checked:hover:bg-emerald-200! rounded-sm flex items-center justify-center aspect-square h-full"><input type="checkbox" class="opacity-0 absolute pointer-events-none"/><slot></slot></label>`);
